...
function Navbar() {
  ...
  return (
    <nav className="z-50">
      <ul className="w-full flex justify-center space-x-8 list-none py-3 lg:py-5 bg-navbar font-['Montserrat'] font-medium text-sm text-center text-white uppercase">
